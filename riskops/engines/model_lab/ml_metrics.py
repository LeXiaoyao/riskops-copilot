...
def render_ml_report(
    ...
    lines = [
        ...
        f"- **score_date_guard**：{dataset_summary.get('score_date_guard', 'not_recorded')}",
        f"- **score_date_fallback_strategy**：{dataset_summary.get('score_date_fallback_strategy', 'not_recorded')}",
        f"- **score_date_fallback_count**：{dataset_summary.get('score_date_fallback_count', 0)}",
        f"- **score_date_missing_count**：{dataset_summary.get('score_date_missing_count', 0)}",
        f"- **future_score_blocked_count**：{dataset_summary.get('future_score_blocked_count', 0)}",
        "- **grain**：loan_id / 借据级",
        "",
        "## Target Definition",
        "",
